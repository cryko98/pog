...
export const STEPS: Step[] = [
  ...
  },
  {
    id: 'chop',
    title: 'Fell a pine',
    hint: 'Walk up to a pine and hold E. Five swings and it comes down — wood is the start of everything.',
    touchHint: 'Walk up to a pine and hold the ACT button. Five swings and it comes down.',
    target: 'tree',
    done: (s) => s.wood >= 2,
  },
  {
  ...
  },
  {
    id: 'fish',
    title: 'Catch a fish',
    hint: 'The holes are out on the frozen lakes. Press E once to cast, then stay put — a bite comes every five seconds.',
    touchHint: 'The holes are out on the frozen lakes. Press ACT once to cast, then stay put — a bite comes every five seconds.',
    target: 'hole',
    done: (s) => s.fish >= 1,
  },
  {
    ...
    hint: 'Rare ones are worth more than one. Keep the line in.',
    target: 'hole',
